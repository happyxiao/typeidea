...
class Link(models.Model):
    ...
    status = models.SmallIntegerField(default=STATUS_NORMAL, choices=STATUS_ITEMS, verbose_name='状态')
...
class SideBar(models.Model):
    ...
    status = models.SmallIntegerField(choices=STATUS_ITEMS, default=STATUS_SHOW, verbose_name='状态')
    owner = models.ForeignKey(User, verbose_name='作者')
    created_time = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
